...
$INSTALL hyprland hyprpaper hypridle hyprlock mako hyprpolkitagent qt5-wayland qt6-wayland noto-fonts waybar grim slurp wofi nautilus iwd impala rsync btop 
